...
#' @param end_year integer / character specifying the year to end the calendar.
...
#' @export
#'
build_trading_calendar <- function(start_year,
                                   end_year = NULL,
...
#' @export
#'
get_trading_periods <- function(calendar_dates, format = "%Y-%m-%d", .keep_calendar_dates = FALSE) {
  ...
  trading_calendar <- build_trading_calendar(start_year)
